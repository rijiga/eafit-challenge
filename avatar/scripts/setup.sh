#!/usr/bin/env bash
# =============================================================================
# Avatar Issuer VS — Local Setup
# =============================================================================
#
# This script sets up the Avatar Issuer VS Agent locally (child service):
...
SERVICE_NAME="${SERVICE_NAME:-Avatar Issuer}"
...
SERVICE_DESCRIPTION="${SERVICE_DESCRIPTION:-Avatar credential issuer for the EAFIT Challenge}"
...
CUSTOM_SCHEMA_BASE_ID="${CUSTOM_SCHEMA_BASE_ID:-avatar}"
...
log "Avatar Issuer VS setup complete!"
echo ""
